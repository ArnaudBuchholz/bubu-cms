import { IStorage, SearchResult, SortableField } from '../types/IStorage'
import { TypeDefinition, saveTypeDefinition } from '../types/TypeDefinition'
import { StoredRecordType, StoredRecordId, isStoredRecordId, StoredRecord, STOREDRECORDTYPE_TAG } from '../types/StoredRecord'
