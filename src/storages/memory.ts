...
import { MAX_STOREDRECORDID_LENGTH, StoredRecordId, StoredRecordType, StorableRecord, StoredRecord, StoredRecordRefs, STOREDRECORDTYPE_TYPE } from '../types/StoredRecord'
...
export class MemoryStorage implements IStorage {
  ...
  async create (record: StorableRecord): Promise<StoredRecordId> {
    ...
    this.addRef(STOREDRECORDTYPE_TYPE, type, stored)
