import { StoredRecordRefs, STOREDRECORDTYPE_TAG, STOREDRECORDTYPE_TYPE } from '../types/StoredRecord'
import { IStorage, SearchOptions, SearchResult, encodeSearchOptions } from '../types/IStorage'
import { DEFAULT_PAGE_SIZE, search, decodeSearchOptions } from './search'
